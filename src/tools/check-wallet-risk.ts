...
export function checkWalletRiskTool(server: McpServer) {
  server.tool(
    "checkWalletRisk",
    {
...
function generateWalletAnalysis(
  profile: any,
  riskScore: number,
  redFlags: string[],
  walletType: string
...
function getWalletRecommendations(riskLevel: string, redFlags: string[], walletType: string): string[] {
